import './App.css';
import logo from './logo.svg'; // Assuming you still need this
import heros from './assets/heros.png'; // Replace with correct path
  ...
  return (
    <div className="App">
      <div className="hero-section">
        <a href="#"><i className="fa-solid fa-users"></i> Log in</a>
      </div>
